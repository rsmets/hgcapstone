Rails.application.routes.draw do
  ...
  get 'data_menu/data' => 'data_menu#data'
  ...
  get 'data_menu/:data_id/pick_range/:num,:num2/pick_correlation_submit' => 'data_menu#pick_correlation_submit', as: :pick_correlation_submit
