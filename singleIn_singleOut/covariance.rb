...
# WARNING !!!!!!!!!!
# WARNING
# WARNING: covariance values cannot be compared with each other
#
#
# output: value between -infinity to infinity where:
# 		  -infinity = more inversely correlated
# 		  0 = not correlated
# 		  infinity = more directly correlated
...
def covariance(a,b)
  ...
  # run algorithm
  output=Statsample::Bivariate.covariance(c,d)
  return output
end

def test(num1 = 0, num2 = 0, a1 = [0.0], a2 = [0.0])
  puts "covariance(#{num1},#{num2})= #{covariance(a1,a2)}"
end
